...
\begin{table}[h]
    ...
    16 tavua       & 8,18 GB             & 2185s = 36min 25s             & 6399ms     \\
...
\begin{table}[h]
    ...
    \hline
    pisteiden esitysmuoto & tiedoston koko & rakentaminen ja tallentaminen & läpikäynti \\ \hline
    16 tavua & 3,62GB              & 791s = 13min 11s              & 1060ms     \\
...
\begin{figure}[h]
    ...
    \caption{Työmaa-pilven kahden miljoonan pisteen renderöintiin vaadittu aika millisekunteina kahdella eri renderöintialgoritmilla}
    \label{ws_ms}
\end{figure}

Kuvassa \ref{ws_ms} on tehty vastaavat mittaukset työmaa-pilvelle. Oranssin viivan kuvaamassa renderöintitavassa on yleiskuvapuskurissa puun viisi ylintä kerrosta, 1862 solmua ja 481663 pistettä.
